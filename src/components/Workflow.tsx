  ...
  return <section className="py-20 bg-gradient-card">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {steps.map((step, index) => <div key={index} className="relative group animate-slide-in-left" style={{
          animationDelay: `${index * 0.2}s`
        }}>
              {/* Connection Line */}
              {index < steps.length - 1 && <div className="hidden lg:block absolute top-16 left-full w-8 h-0.5 bg-border z-0" />}
              ...
              <div className="relative z-10 text-center">
                ...
                <ul className="space-y-1 text-sm">
                  {step.details.map((detail, detailIndex) => <li key={detailIndex} className="flex items-center justify-center text-muted-foreground">
